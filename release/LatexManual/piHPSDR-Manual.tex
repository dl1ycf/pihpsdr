...
\end{itemize}
Note that the front panel of the second-generation (8-inch screen with LEDs)
Anan G2 radios is not controlled via GPIO. For these
...
speakers emit an audible ``plop'' each time the speaker amplifier is muted or un-muted.
