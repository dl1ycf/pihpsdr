...
\begin{itemize}
\item{One serial port can be used for a PTT-input and a PTT-output line.}
\item{Added CW texts that can be changed in the CW menu and transmitted upon pushing
