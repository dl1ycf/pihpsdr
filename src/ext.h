...
extern int ext_start_tx(gpointer data);        // is this necessary?
extern int ext_start_rx(gpointer data);
extern int ext_start_vfo(gpointer data);
extern int ext_start_band(gpointer data);
