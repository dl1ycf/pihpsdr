...
OPTIONS=$(MIDI_OPTIONS) $(USBOZY_OPTIONS) $(GPIO_OPTIONS) $(SOAPYSDR_OPTIONS) \
	$(AUDIO_OPTIONS) $(TCI_OPTIONS) $(PNP_OPTIONS) \
...
INCLUDES=$(GTK_INCLUDE) $(WDSP_INCLUDE) $(OPENSSL_INCLUDE) $(AUDIO_INCLUDE) \
	$(USBOZY_INCLUDE) $(SOAPYSDR_INCLUDE) $(OPUS_INCLUDE) \
...
LIBS=	$(LDFLAGS) $(AUDIO_LIBS) $(USBOZY_LIBS) $(GTK_LIBS) $(GPIO_LIBS) \
	$(SOAPYSDR_LIBS) $(MIDI_LIBS) $(TTS_LIBS) $(OPUS_LIBS) \
